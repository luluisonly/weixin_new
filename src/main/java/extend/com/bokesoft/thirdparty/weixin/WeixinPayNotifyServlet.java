...
//	private static final String dsNotifyUrl = SharedBundle.getProperties("server.soa.activity.paynotify");
	...
	private static Logger LOGGER = Logger.getLogger(WeixinPayNotifyServlet.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String responseStr = "";
		try {
			Map<String, String> result = WXPaySecurityUtils.vaildateWXPaySign(request, key);
	...
	private static String sendPayInfo2UserCenter(Map<String, String> result,TradeType mark,String url) throws Throwable {
		...
		headers.put("__sessionid", result.get("openid"));
