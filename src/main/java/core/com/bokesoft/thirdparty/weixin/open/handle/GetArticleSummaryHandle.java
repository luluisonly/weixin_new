 ...
 *
 */
public class GetArticleSummaryHandle extends AbstractWeixinSOAServieHandle  {
	...
	public SOAResponseMessage handle(WeixinContext context, SOARequestMessage requestMessage)
		...
		String result = apiInvoker.getStatisticsData(access_token, "getArticleSummary",dateInfo);
