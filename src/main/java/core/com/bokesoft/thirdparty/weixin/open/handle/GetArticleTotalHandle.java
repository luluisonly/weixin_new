 ...
 *
 */
public class GetArticleTotalHandle extends AbstractWeixinSOAServieHandle  {
	...
	public SOAResponseMessage handle(WeixinContext context, SOARequestMessage requestMessage)
		...
		String result = apiInvoker.getStatisticsData(access_token, "getArticleTotal",dateInfo);
