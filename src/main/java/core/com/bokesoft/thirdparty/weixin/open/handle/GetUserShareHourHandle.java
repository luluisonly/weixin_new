 ...
 *
 */
public class GetUserShareHourHandle extends AbstractWeixinSOAServieHandle  {
	...
	public SOAResponseMessage handle(WeixinContext context, SOARequestMessage requestMessage)
		...
		String result = apiInvoker.getStatisticsData(access_token, "getUserShareHour", dateInfo);
